...
let ui = {
    ...
    boolean:{
        ...
        inverted: document.getElementById('driveInverted')
    }
};
...
//Booleans
    ...
    let updateDriveInverted = (key, value)=>{
        ui.boolean.pickup.style = (value == true)? "height:20px; background-color:green" : "height:20px; background-color:red";
    }
    NetworkTables.addKeyListener('/SmartDashboard/subsystem-drivetrain/inverted', updateDriveInverted);
///BUTTON CLICKS
